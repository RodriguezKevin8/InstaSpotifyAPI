				...
				<div className="search-results">
					<div className="result-item">
						...
						<div className="result-info">
							<h3>
								<Link to="/UserProfile">DUKI</Link>
							</h3>
							<p>Mauro Ezequiel Lombardo - 13.7 M seguidores</p>
						</div>
					</div>
					<div className="result-item">
						<img src="/img/BadBunny.jpg" alt="Bad Bunny" className="result-avatar" />
						<div className="result-info">
							<h3>
								<Link to="/UserProfile">BAD_BUNNY</Link>
							</h3>
							<p>Benito Martínez Ocasio - 45.6 M seguidores</p>
						</div>
					</div>
					<div className="result-item">
						<img src="/img/eladio.png" alt="Eladio Carrión" className="result-avatar" />
						<div className="result-info">
							<h3>
								<Link to="/UserProfile">CARION.ELA</Link>
							</h3>
