  ...
  return (
    <div className="playlist-view">
      ...
      <div className="playlist-header">
        <img src="/img/Portada1.jpeg" alt="Playlist Cover" className="playlist-cover" />
        <div className="playlist-info">
          <h2 className="playlist-title">Mix diario 1</h2>
          <p className="playlist-description">Mora, Eladio Carrion, Dei V y más</p>
          <p className="playlist-details">Hecho para Gabriel - 50 canciones, 2 h 51 min</p>
          <div className="playlist-actions">
          <button >
          <img src="/icons/Play.svg" alt="Play" className="PlaylistButtons" />
        </button>
          </div>
        </div>
      </div>
